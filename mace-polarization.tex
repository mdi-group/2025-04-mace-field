...
\begin{equation}
\begin{aligned}
    Z^*_{\alpha, ij} &= -\frac{1}{e}\frac{\partial^2 E}{\partial \mathcal{E}_i\ \partial R_{\alpha,j}}\bigg\rvert_{\bm{\mathcal{E}}=\vb{0}} \\
    &= \frac{1}{e} \frac{\partial F_i}{\partial \mathcal{E}_j}\bigg\rvert_{\bm{\mathcal{E}}=\vb{0}} = \frac{\Omega}{e} \frac{\partial P_i}{\partial R_{\alpha, j}}\bigg\rvert_{\bm{\mathcal{E}}=\vb{0}}.
\end{aligned}
\end{equation}
